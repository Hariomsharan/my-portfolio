...
const Skills = () => {
  ...
  return (
    <section
      ref={container}
      id="skills"
      className="py-24 px-6 md:px-12 lg:px-24 bg-dark overflow-hidden"
    >
      <h2 className="text-xs uppercase tracking-[0.5em] text-gold mb-5 font-bold">
        Expertise
      </h2>
      <div className="overflow-hidden">
        <h3 className="reveal-text text-4xl md:text-6xl font-light tracking-tighter uppercase text-white mb-16">
          Skills & Tools
        </h3>
      </div>
