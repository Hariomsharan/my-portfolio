...
const Hero = () => {
  ...
  return (
    <section ref={container} className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden bg-dark">
      ...
      <div className="max-w-4xl">
        <p className="hero-reveal text-gold text-[10px] md:text-xs uppercase tracking-[0.6em] mb-6 font-bold">
          Based in India • Open for Freelance
        </p>

        <h1 className="hero-reveal text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter leading-[0.85] uppercase mb-8">
          HARIOM <br /> 
          <span className="text-transparent border-white/20" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.3)' }}>
            SHARAN
          </span>
        </h1>

        <p className="hero-reveal max-w-lg mx-auto text-gray-400 text-sm md:text-lg leading-relaxed mb-12 font-light">
          Architecting premium MERN stack applications with a focus on 
          minimalist design and cinematic performance.
        </p>
        ...
        <div className="hero-reveal flex flex-col md:flex-row items-center justify-center gap-6">
          ...
          <a 
            href="#contact" 
            className="text-[10px] uppercase tracking-[0.2em] border-b border-white/20 pb-1 hover:border-gold transition-all"
          >
            Get in touch
          </a>
        </div>
